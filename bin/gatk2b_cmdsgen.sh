...
if [ $# -lt 3 ] ; then
   ...
   echo ""
   echo -e "\twindows:\tcoords list file generated by the gatk0_index.sh script"
   echo -e "\tgenome.fasta:\tFASTA formatted reference genome"
   echo -e "\tfinal.bam files:\tregex matching final BAM files from processing step"
   echo ""
   exit 0
fi
